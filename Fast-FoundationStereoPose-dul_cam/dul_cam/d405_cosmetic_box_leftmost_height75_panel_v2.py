...
from dobot_nova5_driver.handoff_clearance_v2 import (
    HandoffClearanceResult,
    evaluate_camera_right_handoff_clearance,
    evaluate_gripper_side_clearance,
    measure_voxel_overlap,
)
from dobot_nova5_driver.gripper_width_policy_v2 import select_gripper_width
from dobot_nova5_driver.top_surface_geometry_v2 import (
...
D405_OUTPUT_DIR = os.path.join(os.path.dirname(os.path.realpath(__file__)), "d405_output_v2")
...
rclpy.init()
ros_node = rclpy.create_node("d405_cosmetic_box_height75_node_v2")
