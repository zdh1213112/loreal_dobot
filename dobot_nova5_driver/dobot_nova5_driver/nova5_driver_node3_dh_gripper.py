...
if __package__ in (None, ""):
    ...
    from dobot_nova5_driver.dobot_dh_api import DobotDHConfig, DHGripper
    ...
    from .dobot_dh_api import DobotDHConfig, DHGripper
...
class Nova5DriverNode(Node):
    ...
    def _init_dh_gripper_if_enabled(self) -> None: #初始化 DH 夹爪连接
        ...
        self._dh_dashboard = DobotApiDashboard(config.robot_ip, config.dashboard_port)
    ...
    def _disconnect_dh_gripper(self) -> None:
        ...
        if self._dh_dashboard is not None:
            try:
