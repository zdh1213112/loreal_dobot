"""V3 entry point for publishing USB-keyboard scanner values to ROS 2."""
...
from .scanner_input_v3 import ScannerInputReader, find_scanner_event_device


class BarcodeScannerNode(Node):
    def __init__(self) -> None:
        super().__init__("hid_barcode_scanner_node_v3")
